...
function LoginPage() {
  ...
  return(
    <div className='h-screen  flex justify-center items-center bg-blue-50'>
      ...
      <div className=' lg:h-3/4 h-1/2 2xl:h-1/2   shadow-2xl rounded-[30px] overflow-hidden 2xl:w-1/2 w-3/4 grid md:grid-cols-5 '>
        <div className='col-span-2 bg-white h-full p-8 flex flex-col justify-center'>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className='ml-0 mt-2 text-sm flex flex-col p-4'>
              ...
              <input type='password' placeholder='atleast 8 characters' name=' password' className='rounded-sm border  h-10 mt-2 p-1' value={password || ''} required   onChange={handlePasswordChange}/>
            </div>
