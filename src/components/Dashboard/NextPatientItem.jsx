        ...
        <div className="bg-white p-4 mt-3 max-h-full  min-h-[400px] overflow-auto mr-6">
            ...
            <div className="mt-6">
                ...
                <div className="pt-4 mt-2">
                    <button className="bg-yellow-100  rounded-md text-yellow font-semibold text-yellow-300 p-1 pr-2 pl-2">Asthma</button>
                    <button className="bg-green-50  rounded-md text-yellow font-semibold text-green-300 p-1 pr-2 pl-2 ml-2">Hypertension</button>
                    <button className="bg-purple-50  rounded-md text-yellow font-semibold text-purple-300 p-1 pr-2 pl-2 ml-2">Ulcers</button>
                </div>
                <div className="pt-4 mt-2 flex">
                    <button className="flex bg-blue-400 text-white items-center rounded-md p-2 "><BsTelephone/>
                        <span className="ml-2"> (256) 705-976941</span>
                    </button>
                    <button className="flex bg-white text-blue-400 items-center rounded-md p-2 pl-3 pr-4  border border-blue-400 ml-2 "><BsFolder2 className="text-lg"/>
                        <span className="ml-2"> Documents</span>
                    </button>
                    <button className="flex bg-white text-blue-400 items-center rounded-md  pl-3 pr-4  border border-blue-400 ml-2 "><BsChatLeft />
